...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="./login.php" class="h1 text-decoration-none"><b>Log Masuk Pembeli</b></a>
    </div>
    <div class="card-body">
      ...
      <form id="cclogin-frm" action="" method="post">
        <div class="input-group mb-3">
          <input type="email" class="form-control" name="email" autofocus placeholder="E-mel">
        ...
        <div class="row align-item-end">
          ...
          <!-- /.col -->
          <div class="col-4">
            <button type="submit" class="btn text-light btn-block btn-flat" style="background-color:#3C6255;">Log Masuk</button>
          </div>
          <div class="col-12 text-center">
          <a href="<?= base_url.'./register.php' ?>">Buat Akaun</a>
          </div>
          <!-- /.col -->
        </div>
      </form>
...
<script>
  ...
  $(function() {
    // Check if the 'alert' URL parameter is present
    var urlParams = new URLSearchParams(window.location.search);
    if (urlParams.has('alert')) {
        // Display the alert message
        alert_toast('Sila Log Masuk atau Daftar jika mahu membuat tempahan', 'error');
    }
});
</script>
</body>
