                    ...
                    <form id="cregister-frm" action="" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" id="middlename" name="middlename" class="form-control form-control-sm form-control-border" placeholder="pilihan">
                            </div>
                            <div class="form-group col-md-4">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="email" class="control-label">E-mel</label>
                        ...
                        <div class="row align-item-end">
                            ...
                            <a href="<?= base_url.'./login.php' ?>">Sudah mempunyai akaun</a>
                            </div>
                        <!-- /.col -->
                        </div>
                    </form>
