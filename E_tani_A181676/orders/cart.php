...
<div class="content py-3">
    <div class="card card-outline card-navy rounded-0 shadow-0">
        <div class="card-header" style="background-color:#c4d7b2;">
            <h5 class="card-title"><b>Senarai Bakul Pembelian</b></h5>
        </div>
        <div class="card-body" style="background-color:#c4d7b2;">
            <div id="cart-list">
                ...
                ?>
                    <div class="col-12 border text-light" style="background-color:#3C6255;">
                        <span><b>Petani: </b><b><?= $vrow['shop_owner']. " - " . $vrow['shop_name'] ?></b></span>
                    </div>
                    <div class="col-12 border p-0">
                        ...
                        <div class="d-flex align-items-center border p-2">
                            ...
                            <div class="col-auto flex-shrink-1 flex-grow-1">
                                ...
                                <div class="d-flex">
                                    <div class="col-auto px-0"><small class="text-muted">Kuantiti: </small></div>
                                    <div class="col-auto">
                                    ...
                                    <div class="col-auto flex-shrink-1 flex-grow-1">
                                        <button class="btn btn-flat btn-outline-danger btn-sm rem_item"  data-id="<?= $prow['id'] ?>"><i class="fa fa-times"></i> Buang</button>
                                    </div>
                                </div>
                            </div>
                            <div class="col-3 text-right">RM <?= format_num($total) ?></div>
                        </div>
                        <?php endwhile; ?>
                    </div>
                    <div class="col-12 border">
                        <div class="d-flex">
                            <div class="col-9 text-right font-weight-bold text-muted">Jumlah</div>
                            <div class="col-3 text-right font-weight-bold">RM <?= format_num($vtotal) ?></div>
                        </div>
                    </div>
                <?php endwhile; ?>
                    <div class="col-12 border">
                        <div class="d-flex">
                            <div class="col-9 h4 font-weight-bold text-right text-muted">Jumlah Semua</div>
    ...
    <div class="text-right">
        <a href="./?page=orders/checkout" class="btn btn-flat btn-primary btn-sm"><i class="fa fa-money-bill-wave"></i> Pembelian</a>
    </div>
</div>
<script>
    $(function(){
        ...
        _conf("Adakah anda pasti memadamkan item ini daripada senarai bakul?",'delete_cart',[$(this).attr('data-id')])
        })
    })
