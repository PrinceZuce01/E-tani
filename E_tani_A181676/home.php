...
<div class="col-lg-12 py-5">
    <div class="contain-fluid">
        ...
        <h3 class="text-center"><b>Produk</b></h3>
                ...
                <div class="product-img-holder position-relative">
                    ...
                    <div class="card-body border-top border-gray">
                        ...
                        <div class="d-flex w-100">
                            ...
                            <div class="col-auto px-0 flex-shrink-1 flex-grow-1"><p class="m-0 pl-2"> <small class="text-muted"><?= $row['vendor'] ?></small></p></div>
                        </div>
                        <div class="d-flex">
                            <div class="col-auto px-0"><small class="text-muted">Kategori:  </small></div>
                            <div class="col-auto px-0 flex-shrink-1 flex-grow-1"><p class="m-0 pl-2"> <small class="text-muted"><?= $row['category'] ?></small></p></div>
                        </div>
                        <div class="d-flex">
        ...
        <div class="text-center">
            <a href="./?page=products" class="btn btn-large text-light rounded-pill col-lg-3 col-md-5 col-sm-12" style="background-color:#3C6255;">Ketahui Produk Lagi</a>
        </div>
    </div>
</div>