...
<?php require_once('inc/header.php') ?>
  <body class="layout-top-nav layout-fixed layout-navbar-fixed" style="height: auto;">
    <div class="wrapper">
     ...
     <?php if($_settings->chk_flashdata('success')): ?>
      ...
      <div class="content-wrapper pt-5" style="background-color: #A0C49D;">
  ...
  <div class="modal fade rounded-0 " id="uni_modal" role='dialog'>
    <div class="modal-dialog modal-md modal-dialog-centered rounded-0" role="document">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-sm text-light" style="background-color:#3C6255;" id='submit' onclick="$('#uni_modal form').submit()">Simpan</button>
  ...
  <div class="modal fade rounded-0" id="confirm_modal" role='dialog'>
    <div class="modal-dialog modal-md modal-dialog-centered" role="document">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-flat text-light" style="background-color:#3C6255;" id='confirm' onclick="">Teruskan</button>
