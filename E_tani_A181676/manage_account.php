...
<div class="content py-3"></div>
	<div class="card card-outline rounded-0 card-primary shadow">
				...
				<form action="" id="manage-user">	
					...
					<div class="row">
                        <div class="form-group col-md-4">
                            <label for="firstname" class="control-label">Nama Pertama</label>
                        ...
                        <div class="form-group col-md-4">
                            <label for="lastname" class="control-label">Nama Terakhir</label>
                        ...
                        <div class="form-group col-md-4">
                            <label for="gender" class="control-label">Jantina</label>
                            <select type="text" id="gender" name="gender" class="form-control form-control-sm form-control-border select2" required>
                                <option <?= isset($gender) && $gender == "Male" ? 'selected' : '' ?>>Lelaki</option>
                                <option <?= isset($gender) && $gender == "Female" ? 'selected' : '' ?>>Perempuan</option>
                            </select>
                        </div>
                        <div class="form-group col-md-4">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label for="password" class="control-label">Kata Laluan Baharu</label>
                        ...
                        <div class="form-group col-md-6">
                            <label for="cpassword" class="control-label">Sahkan Kata Laluan</label>
                            <div class="input-group input-group-sm">
						...
						<small class="text-muted"><i>Biarkan Kata Laluan Baharu Kosong jika anda tidak mahu mengemas kininya.</i></small>
                    </div>
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label for="logo" class="control-label">Gambar</label>
                            <input type="file" id="logo" name="img" class="form-control form-control-sm form-control-border" onchange="displayImg(this,$(this))" accept="image/png, image/jpeg, image/jpg">
                        </div>
                    </div>
                    <div class="row">
					...
					<div class="row">
						<div class="form-group col-md-6">
							<label for="oldpassword" class="control-label">Masukkan Kata Laluan Semasa</label>
							<div class="input-group input-group-sm">
		...
		<div class="card-footer text-center">
				<button class="btn btn-sm btn-primary" form="manage-user">Kemaskini</button>
		</div>
	</div>
</div>
<script>
	...
	$(function(){
		...
		$('#manage-user').submit(function(e){
			...
			if($('#password').val() != $('#cpassword').val()){
				el.addClass('alert-danger').text('Kata Laluan tidak sah.')
				_this.prepend(el)
				el.show('slow')
