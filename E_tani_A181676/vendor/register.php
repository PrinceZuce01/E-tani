        ...
        <div class="col-7 h-100 bg-gradient-light px-4">
            <div class="d-flex justify-content-center align-items-center w-100 h-100">
                <div class="card card-outline card-primary col-12 rounded-0 shadow">
                    ...
                    <a href="./register.php" class="h1"><b>Buat Akaun</b></a>
                    </div>
                    <div class="card-body">
                    ...
                    <form id="vregister-frm" action="" method="post">
                        ...
                        <div class="row align-item-end">
                            ...
                            <!-- /.col -->
                            <div class="col-4">
                                <button type="submit" class="btn text-light btn-block btn-flat" style="background-color:#3C6255;">Buat akaun</button>
                            </div>
                            <div class="col-12 text-center">
                            <a href="<?= base_url.'vendor/login.php' ?>">Sudah mempunyai akaun</a>
                            </div>
                        <!-- /.col -->
                        </div>
                    </form>
...
<script>
  ...
  $(function(){
    ...
    $('.select2').select2({
        placeholder:"Sila Pilih Jenis Kedai",
        width:'100%'
    })
