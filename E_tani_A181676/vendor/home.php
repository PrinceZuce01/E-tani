<h1 class="">Selamat Datang ke <?php echo $_settings->info('name') ?> - Bahagian Petani</h1>
<style>
  #cover-image{
    width:calc(100%);
    height:50vh;
...
<div class="row">
  <div class="col-12 col-sm-4 col-md-4">
    <div class="info-box" style="background-color:#C4D7B2;">
      ...
      <div class="info-box-content">
        <span class="info-box-text text-bold">Jumlah Kategori</span>
  ...
  <div class="col-12 col-sm-4 col-md-4">
    <div class="info-box" style="background-color:#C4D7B2;">
      ...
      <div class="info-box-content">
        <span class="info-box-text text-bold">Jumlah Produk</span>
        <span class="iinfo-box-number text-right h4">
          <?php 
  ...
  <div class="col-12 col-sm-4 col-md-4">
    <div class="info-box" style="background-color:#C4D7B2;">
      ...
      <div class="info-box-content">
        <span class="info-box-text text-bold">Jumlah Pesanan Belum Selesai</span>
        <span class="iinfo-box-number text-right h4">
          <?php 
