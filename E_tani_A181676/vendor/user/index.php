...
<div class="content py-3"></div>
	<div class="card card-outline rounded-0 card-primary shadow">
				...
				<form action="" id="manage-user">	
					...
					<div class="row">
						<div class="form-group col-md-6">
							<label for="shop_name" class="control-label">Nama Kedai</label>
						...
						<div class="form-group col-md-6">
							<label for="shop_owner" class="control-label">Nama Penuh Pemilik Kedai</label>
						...
						<div class="form-group col-md-6">
							<label for="contact" class="control-label">No tel</label>
						...
						<div class="form-group col-md-6">
							<label for="shop_type_id" class="control-label">Jenis Kedai</label>
					...
					<div class="row">
						<div class="form-group col-md-6">
							<label for="username" class="control-label">Kata Nama</label>
					...
					<div class="row">
						...
						<div class="form-group col-md-6">
							<label for="cpassword" class="control-label">Sahkan Kata Laluan Baharu</label>
							<div class="input-group input-group-sm">
						...
						<small class="text-muted">Biarkan Kata Laluan Baharu Kosong jika anda tidak mahu mengemas kininya.</small>
					</div>
					<div class="row">
						<div class="form-group col-md-6">
							<label for="logo" class="control-label">Logo Kedai</label>
		...
		<div class="card-footer">
			<div class="col-md-12">
				<div class="row">
					<button class="btn btn-sm btn-primary" form="manage-user">Kemas kini</button>
				</div>
			</div>
		</div>
	</div>
	...
	$(function(){
		...
		$('#manage-user').submit(function(e){
			...
			if($('#password').val() != $('#cpassword').val()){
				el.addClass('alert-danger').text('Kata laluan tidak sepadan.')
				_this.append(el)
				el.show('slow')
			...
			$.ajax({
				...
				error:err=>{
					console.error(err)
					el.addClass('alert-danger').text("Ralat berlaku.");
					_this.prepend(el)
					el.show('.modal')
					end_loader();
				},
