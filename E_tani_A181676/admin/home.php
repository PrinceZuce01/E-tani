<h1 class="">Selamat Datang ke <?php echo $_settings->info('name') ?> - Bahagian Admin</h1>
<style>
  #cover-image{
    width:calc(100%);
    height:50vh;
...
<div class="row">
  <div class="col-12 col-sm-4 col-md-4">
    <div class="info-box" style="background-color:#C4D7B2;">
      <span class="info-box-icon bg-gradient-primary elevation-1"><i class="fas fa-th-list"></i></span>

      <div class="info-box-content">
        <span class="info-box-text"><b>Jumlah Kategori</b></span>
  ...
  <div class="col-12 col-sm-4 col-md-4">
    <div class="info-box" style="background-color:#C4D7B2;">
      ...
      <div class="info-box-content">
        <span class="info-box-text"><b>Jumlah Jenis Kedai</b></span>
        <span class="iinfo-box-number text-right h4">
          <?php 
  ...
  <div class="col-12 col-sm-4 col-md-4">
    <div class="info-box" style="background-color:#C4D7B2;">
      ...
      <div class="info-box-content">
        <span class="info-box-text"><b>Petani</b></span>
        <span class="iinfo-box-number text-right h4">
          <?php 
    ...
    <div class="info-box" style="background-color:#C4D7B2;">
      ...
      <div class="info-box-content">
        <span class="info-box-text"><b>Pembeli</b></span>
        <span class="iinfo-box-number text-right h4">
          <?php 
  ...
  <div class="col-12 col-sm-4 col-md-4">
    <div class="info-box" style="background-color:#C4D7B2;">
      ...
      <div class="info-box-content">
        <span class="info-box-text"><b>Jumlah Tempahan</b></span>
        <span class="iinfo-box-number text-right h4">
          <?php 
