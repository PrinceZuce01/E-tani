...
<div class="content py-3">
    <div class="card card-outline card-navy shadow rounded-0">
        <div class="card-header">
            <h5 class="card-title">Laporan Tempahan Bulanan</h5>
        </div>
        <div class="card-body">
                        ...
                        <div class="row align-items-end">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <button class="btn btn-light border btn-flat btn-sm" type="button" id="print"><i class="fa fa-print"></i> Cetak</button>
                                </div>
                            </div>
                        </div>
                    </form>
                    ...
                    <table class="table table-bordered table-stripped">
                        ...
                        <thead>
                            <tr class="">
                                ...
                                <th class="text-center align-middle py-1">Petani</th>
                                <th class="text-center align-middle py-1">Status</th>
                                <th class="text-center align-middle py-1">Jumlah Semua</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php 
                        ...
                        <tfoot>
                            <tr>
                                <th class="text-center px-1 py-1 align-middel" colspan="6">Jumlah</th>
...
<script>
    $(function(){
        ...
        $('#print').click(function(){
            ...
            head.find('title').text("Laporan Tempahan Bulanan - Cetakan")
            el.append(head)
            el.append(header)
            el.append(p)
