			...
			<div class="container-fluid">
				...
				<form action="" id="manage-user">	
					...
					<div class="row">
						...
						<div class="form-group col-md-6">
							<label for="shop_owner" class="control-label">Nama Pemilik Kedai</label>
					...
					<div class="row">
						...
						<div class="form-group col-md-6">
							<label for="cpassword" class="control-label">Sah Kata Laluan Baru</label>
							<div class="input-group input-group-sm">
						...
						<small class="text-muted">Tinggalkan ini jika tidak mahu mengubah.</small>
					</div>
					<div class="row">
						<div class="form-group col-md-6">
