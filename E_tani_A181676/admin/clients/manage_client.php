...
if(isset($_GET['id'])){
	...
	if($client->num_rows > 0){
		...
		echo '<script> alert("Pembeli tidak dikenali"); location.replace("./?page=clients")</script>';
	}
...
<div class="content py-3"></div>
	<div class="card card-outline rounded-0 card-primary shadow">
				...
				<form action="" id="manage-user">	
					...
					<div class="row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" id="middlename" name="middlename" class="form-control form-control-sm form-control-border" value="<?= isset($middlename) ? $middlename : "" ?>" placeholder="pilihan">
                        </div>
                        <div class="form-group col-md-4">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            <label for="cpassword" class="control-label">Sah Kata Laluan</label>
                            <div class="input-group input-group-sm">
						...
						<small class="text-muted"><i>Tinggalkan ini jika tidak mahu mengubah kata laluan.</i></small>
                    </div>
                    <div class="row">
                        <div class="form-group col-md-6">
		...
		<div class="card-footer text-center">
				<button class="btn btn-sm btn-primary" form="manage-user">Ubah</button>
		</div>
	</div>
</div>
<script>
	...
	$(function(){
		...
		$('#manage-user').submit(function(e){
			...
			if($('#password').val() != $('#cpassword').val()){
				el.addClass('alert-danger').text('Kata laluan tidak sama.')
				_this.prepend(el)
				el.show('slow')
