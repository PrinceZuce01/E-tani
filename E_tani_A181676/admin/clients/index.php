...
<div class="card card-outline card-primary">
	<div class="card-header">
		<h3 class="card-title">Senarai Pembeli</h3>
	</div>
	<div class="card-body">
					...
					?>
						<tr>
							...
							<td class="text-center">
								<?php if($row['status'] == 1): ?>
									<span class="bage badge-primary px-3 rounded-pill">Aktif</span>
								<?php else: ?>
									<span class="bage badge-danger px-3 rounded-pill">Tidak Aktif</span>
								<?php endif; ?>
							</td>
							<td align="center">
								 <button type="button" class="btn btn-flat btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
				                  ...
				                  <div class="dropdown-menu" role="menu">
				                    <a class="dropdown-item" href="?page=clients/manage_client&id=<?php echo $row['id'] ?>"><span class="fa fa-edit text-primary"></span>Sunting</a>
...
<script>
	$(document).ready(function(){
		$('.delete_data').click(function(){
			_conf("Adakah anda pasti untuk membuang pembeli ini?","delete_client",[$(this).attr('data-id')])
		})
		$('.table').dataTable();
	})
